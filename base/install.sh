...
echo "#"
echo "# 1. Bootstrapping the Biostar Handbook (10 steps)"
echo "#"
...
echo "#"
curl -s http://data.biostarhandbook.com/install/conda.txt | xargs ~/bin/micromamba install -r ${ROOT} -n ${ENV_BIOINFO} -y -q
...
echo "# The Biostar Handbook software installation complete!"
echo "#"
